...
async def finish_recommendation(cb, state):
    ...
    score = {str(i): 0 for i in [1, 4, 7, 10, 13, 16, 19]}
    ...
    explanations = {
        "1": "Помогает коже, гормонам и обмену веществ (Омега-3).",
        "4": "Поддерживает кишечник, печень и желудок.",
        "7": "Улучшает память, фокус и настроение.",
        "10": "Баланс Омега-3/6 снижает тревожность.",
        "13": "Мощная поддержка иммунитета и противовоспалительный эффект.",
        "16": "Подходит для кожи, энергии и мягкого улучшения пищеварения.",
        "19": "Лёгкое масло, универсально подходит большинству людей.",
    }
...
async def chat_start(cb, state):
    ...
    await cb.message.edit_text(
        "💬 <b>Задайте вопрос</b>\n"
        "Можете спросить о применении, дозировке или противопоказаниях."
    )
